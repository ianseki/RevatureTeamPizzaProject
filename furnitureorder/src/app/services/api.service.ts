...
export class APIService {
  ...
  // CUSTOMER FUNCTIONS
  public CUSTOMER_Login(INPUT_Email: string, INPUT_Password: string){
  ...
  public CUSTOMER_CreateNewUser(INPUT_Firstname: string, INPUT_Lastname: string, INPUT_Email: string, INPUT_Password: string){
  ...
  public CUSTOMER_CreateNewOrder(INPUT_CustomerID: number, INPUT_DTO_OrderProject: DTO_OrderProject){
    const API_URL = 'https://woodcutters-union-team-pizza.azurewebsites.net/API/Customer/CreateNewCustomer';
    const API_Parameters = new HttpParams()
  ...
  public CUSTOMER_GetOrderHistory(INPUT_CustomerID: number){
    const API_URL = 'https://woodcutters-union-team-pizza.azurewebsites.net/API/Customer/CreateNewCustomer';
    const API_Parameters = new HttpParams()
      .set("INPUT_CustomerID", INPUT_CustomerID)
  ...
  // EMPLOYEE FUNCTIONS
  public EMPLOYEE_Login(INPUT_Email: string, INPUT_Password: string){
  ...
  public EMPLOYEE_CreateNewUser(INPUT_Firstname: string, INPUT_Lastname: string, INPUT_Email: string, INPUT_Password: string){
  ...
  public EMPLOYEE_UpdateProjectStatus(INPUT_ProjectID: number, INPUT_ProjectStatus: boolean)
  {
  ...
  public EMPLOYEE_GetOutstandingProject(INPUT_EmployeeID: number)
  {
